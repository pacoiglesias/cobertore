...
title Instalador de mejoras SEO/GEO - cobertores.com

echo ============================================================
echo   Instalador de mejoras SEO/GEO - cobertores.com
echo ============================================================
echo.
echo   Este script:
echo    1. Respalda los archivos actuales (como .zip, fuera del build)
echo    2. Extrae cobertore_seo_mejoras.zip
echo    3. Sobrescribe los 5 archivos con las versiones mejoradas
...
set "ZIPFILE=cobertore_seo_mejoras.zip"
...
REM --- 4. FIX: mover respaldos sueltos de corridas anteriores del .bat ---
REM Una version anterior de este script dejaba .tsx sueltos dentro de
REM respaldos\pre-seo-*\ , y como tsconfig.json incluye "**/*.tsx" sin
REM excluir esa carpeta, Next.js intentaba compilarlos tambien y el
REM build fallaba. Los movemos fuera del proyecto (no se pierden).
...
REM --- 5. Generar timestamp confiable con PowerShell ---
set "TS="
...
set "STAGE_DIR=%TEMP%\cobertore_stage_%RANDOM%"
mkdir "%STAGE_DIR%\src\app\[lang]" 2>nul
mkdir "%STAGE_DIR%\public" 2>nul

if exist "src\app\page.tsx"                 copy /Y "src\app\page.tsx" "%STAGE_DIR%\src\app\page.tsx" >nul
if exist "src\app\layout.tsx"               copy /Y "src\app\layout.tsx" "%STAGE_DIR%\src\app\layout.tsx" >nul
...
if exist "public\llms.txt"                  copy /Y "public\llms.txt" "%STAGE_DIR%\public\llms.txt" >nul

set "BACKUP_ZIP=respaldos\pre-seo-%TS%.zip"
...
set "TEMP_DIR=%TEMP%\cobertore_seo_%RANDOM%"
...
set "OK=1"
xcopy /Y /I "%TEMP_DIR%\src\app\page.tsx" "src\app\" >nul                        || set "OK=0"
xcopy /Y /I "%TEMP_DIR%\src\app\layout.tsx" "src\app\" >nul                      || set "OK=0"
xcopy /Y /I "%TEMP_DIR%\src\app\[lang]\page.tsx" "src\app\[lang]\" >nul          || set "OK=0"
xcopy /Y /I "%TEMP_DIR%\src\app\[lang]\LandingClient.tsx" "src\app\[lang]\" >nul || set "OK=0"
xcopy /Y /I "%TEMP_DIR%\public\llms.txt" "public\" >nul                          || set "OK=0"
...
echo   OK - 5 archivos actualizados:
echo     - src\app\page.tsx
echo     - src\app\layout.tsx
echo     - src\app\[lang]\page.tsx
...
echo   Estos cambios solo tocan Hosting (no Firestore/Storage/Functions),
echo   asi que basta con "firebase deploy --only hosting".
echo.
