        ...
        <div className="grid md:grid-cols-2 gap-10">
          {[
            ...
            <motion.div
              ...
              className="bg-[#070b14] border border-white/5 p-9 lg:p-10 rounded-3xl hover:border-amber-500/30 hover:bg-white/[0.02] transition-all duration-300 shadow-xl"
            >
              ...
              <h3 className="font-serif text-white text-2xl mt-4">{block.title}</h3>
              <p className="text-slate-400 mt-4 leading-relaxed font-light">{block.copy}</p>
            </motion.div>
          ))}
        </div>
      </div>
